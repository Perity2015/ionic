!function (e, n) {
  ...
  if (e.getElementsByTagName("head")[0].appendChild(t), t.styleSheet)t.styleSheet.disabled || (t.styleSheet.cssText = n); else try {
    t.innerHTML = n
  } catch (a) {
    t.innerText = n
  }
  ...
  this.configDatePicker = function (n) {
    ...
    function d(e) {
      ...
      var n = new Date(e.getFullYear(), e.getMonth(), 1).getDate(), t = new Date(e.getFullYear(), e.getMonth() + 1, 0).getDate();
    ...
    return u.today = i(new Date).getTime(), u.disabledDates = [], u.data = {}, u.prevMonth = function () {
    ...
    }, a.fromTemplateUrl("ionic-datepicker-modal.html", {scope: u, animation: "slide-in-up"}).then(function (e) {
      u.modal = e
      ...
      delete u.fromDate, delete u.toDate, u.mainObj = angular.extend({}, e, n), u.mainObj.from && (u.fromDate = i(new Date(u.mainObj.from)).getTime()), u.mainObj.to && (u.toDate = i(new Date(u.mainObj.to)).getTime()), n.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = n.disableWeekdays.concat(e.disableWeekdays)), r(u.mainObj), u.mainObj.closeOnSelect || (a = [{
        ...
        text: u.mainObj.todayLabel, type: "button_today", onTap: function (e) {
          var n = new Date;
          d(new Date), u.selctedDateEpoch = i(n).getTime(), u.mainObj.closeOnSelect || e.preventDefault()
        }
      }), a.push({
        text: u.mainObj.closeLabel, type: "button_close", onTap: function (e) {
