...
!function (a, b, c) {
  ...
  !function (a) {
    ...
    a.extend(a.mobile, {
      window: a(b), document: a(c), keyCode: a.ui.keyCode, behaviors: {}, silentScroll: function (c) {
    ...
    a.widget("mobile.listview", a.mobile.listview, {
      options: {hideDividers: !1}, _afterListviewRefresh: function () {
        var a, d, e, f = !0;
    ...
    a.widget("mobile.textinput", {
      ...
      _create: function () {
        ...
        this.element.prop("disabled") && (b.disabled = !0), a.extend(this, {
          ...
          isRange: e,
          inputNeedsWrap: f
        }), this._autoCorrect(), b.enhanced || this._enhance(), this._on({focus: "_handleFocus", blur: "_handleBlur"})
      },
      refresh: function () {
